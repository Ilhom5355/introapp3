class Strings{
  ...
  static var stepTwoContent = "Enjoy lifetime access to courses on PDP website and app";
  static var stepThreeTitle = "Find video courses";
  static var stepThreeContent = "Build uour library for your career and personal growth";
